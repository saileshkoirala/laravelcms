...
<div class="nav-side-menu">
    ...
    <div class="container pull-right">
        ...
        <div class="col-md-10 col-md-offset-1">
                ...
                @endif
        		     <center>
                          <form method="POST" id="h1" action="/insertbrand">
                            {{ csrf_field() }}
                            <table class="table">
                                 <td> 
                                        <select type="text" class="col-md-10 form-control input-sm" name="subcatname" required data-validation-required-message>
                                        <option>Select Sub Categories</option>
                                        @foreach($brandoption as $value)
                                ...
                                <tr>
                                    <td><input type="text" name="brandname" class="col-md-10 form-control input-sm" required></td>
                                </tr>
