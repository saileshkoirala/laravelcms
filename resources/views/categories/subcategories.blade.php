...
<div class="nav-side-menu">
    ...
    <div class="container pull-right">
        ...
        <div class="col-md-10 col-md-offset-1">
                ...
                @endif
        		     <center>
                          <form method="POST" id="h1" action="/insertsub">
                            {{ csrf_field() }}
                            <table class="table">
                                 <td> 
                                ...
                                <tr>
                                    <td><input type="text" name="subcatname" class="col-md-10 form-control input-sm" required></td>
                                </tr>
                                <tr>
                                <td>Image<input type="file" name="subimage" class="col-md-10 form-control input-sm" required></td>
                                </tr>
                                <tr>
