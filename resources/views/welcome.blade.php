                   ...
                   <div class="wmuSliderWrapper">         
                       <article style="position: absolute; width: 100%; opacity: 0;">                   
                        ...
                        <div class="col-md-5 banner-bag">
                            <img class="img-responsive " src="{{ URL::asset('images/bag.jpg') }}" alt=" " />
                            </div>
                        ...
                        <div class="banner-matter">
                        <div class="col-md-5 banner-bag">
                            <img class="img-responsive " src="{{ URL::asset('images/bag1.jpg') }}" alt=" " />
                            </div>
                            <div class="col-md-7 banner-off">                           
                                <h2>FLAT 50% 0FF</h2>
                                <label>FOR ALL PURCHASE <b>VALUE</b></label>
                                <p>Lorem ipsum dolor sit amet, con-sed-gridctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et </p>                 
                                <span class="on-get">GET NOW</span>
                            </div>
